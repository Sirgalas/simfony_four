 ...
 */
final class Version20210630082901 extends AbstractMigration
{
    ...
    {
        $this->addSql('CREATE TABLE work_projects_task_changes (
                id INT NOT NULL, 
                task_id INT NOT NULL, 
                actor_id UUID NOT NULL, 
                date TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, 
                set_project_id UUID DEFAULT NULL, 
                set_name VARCHAR(255) DEFAULT NULL, 
                set_content TEXT DEFAULT NULL, 
                set_file_id UUID DEFAULT NULL, 
                set_removed_file_id UUID DEFAULT NULL, 
                set_type VARCHAR(16) DEFAULT NULL, 
                set_status VARCHAR(255) DEFAULT NULL, 
                set_progress SMALLINT DEFAULT NULL, 
                set_priority SMALLINT DEFAULT NULL, 
                set_parent_id INT DEFAULT NULL, 
                set_removed_parent BOOLEAN DEFAULT NULL, 
                set_plan DATE DEFAULT NULL, 
                set_removed_plan BOOLEAN DEFAULT NULL, 
                set_executor_id UUID DEFAULT NULL, 
                set_revoked_executor_id UUID DEFAULT NULL, 
