...
{
    public const TASK_IN_PROJECT_WITH_USER = 101;
    public const TASK_IN_PROJECT_WITHOUT_USER = 102;
    public const TASK_IN_PROJECT_WITH_USER_WITH_PLAN = 103;
    ...
    public function load(ObjectManager $manager): void
    {
        ...
        $task = (new TaskBuilder())
            ...
            ->build($project, $userMember);
        $task->setPlan($userMember, new \DateTimeImmutable(), new \DateTimeImmutable('+1 day'));
        $manager->persist($task);
